<x-app-layout>
    ...
    <div class="content">
        ...
        <div class="work-areas">
            ...
            <form action="{{ route('areas_de_trabajo.update', $areaDeTrabajo->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ocupacion" name="ocupacion" value="{{ $areaDeTrabajo->ocupacion }}" required>
                </div>
                <div class="form-group">
                    <label for="cargo">Cargo</label>
                    <input type="text" class="form-control" id="cargo" name="cargo" value="{{ $areaDeTrabajo->cargo }}" required>
                </div>
                <div class="form-group">
                    <label for="area_asignada">Área Asignada</label>
                    <input type="text" class="form-control" id="area_asignada" name="area_asignada" value="{{ $areaDeTrabajo->area_asignada }}" required>
                </div>
                <div class="form-group">
                    <label for="descripcion">Descripción</label>
                    <textarea class="form-control" id="descripcion" name="descripcion" rows="3">{{ $areaDeTrabajo->descripcion }}</textarea>
                </div>
