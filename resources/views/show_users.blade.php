<x-app-layout>
    ...
    <div class="content">
        <div class="text-center">
            <h1>Usuarios en Área de Trabajo</h1>
        </div>
        
        <div class="work-areas">
            <h2>Usuarios en {{ $areaDeTrabajo->nombre }}</h2>
            <ul>
                @foreach($areaDeTrabajo->users as $user)
                    <li>
                        <div>
                            <strong>Nombre:</strong> {{ $user->name }}<br>
                            <strong>Email:</strong> {{ $user->email }}<br>
                            <strong>Área de Trabajo:</strong> {{ $areaDeTrabajo->nombre }}
                        </div>
                    </li>
                @endforeach
            </ul>
