                ...
                <tbody>
                    @foreach($reportes as $reporte)
                        <tr>
                            ...
                            <td>
                                @php
                                    // Intentamos desencriptar la URL, si no se puede, mostramos un mensaje de error
                                    try {
                                        $urlDesencriptada = \Illuminate\Support\Facades\Crypt::decryptString($reporte->URL);
                                    } catch (Illuminate\Contracts\Encryption\DecryptException $e) {
                                        $urlDesencriptada = 'Error al desencriptar la URL';
                                    }
                                @endphp
                                {{ $urlDesencriptada }}
                            </td>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-danger btn-eliminar" onclick="eliminarReporte()">
                                        <i class="fas fa-trash-alt"></i> Eliminar
                                    </button>
                                    <button class="btn btn-ver-mas" onclick="verUrlModal('{{ $urlDesencriptada }}')">
