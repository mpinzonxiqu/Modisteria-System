...
<head>
    ...
    <style>
        ...
        .card {
            ...
            box-shadow: 0 0 20px rgba(0, 0, 0, 0.1); /* Más sombra para efecto */
        ...
        .card-body {
            text-align: center;
            padding: 40px 30px; /* Espaciado mayor para más comodidad */
        }
        .card-title {
        ...
        .icon {
            font-size: 6rem; /* Aumentamos el tamaño del ícono */
            color: #3087dfb5;
        }
        footer {
            margin-top: 40px;
    ...
    <div class="content">
        ...
        <div class="container mt-5">
            <div class="row text-center">
                <div class="col-md-12"> <!-- Aquí cambiamos col-md-4 a col-md-12 para que ocupe toda la fila -->
                    <div class="card">
                        <div class="card-body">
                            <i class="fas fa-chart-line icon"></i>
                            <h5 class="card-title">Ver Reportes Asignados</h5>
                            <a href="http://127.0.0.1:8000/reportes/asignados" class="btn btn-primary btn-lg">Ver Más</a> <!-- Cambio a un enlace con clase btn -->
                        </div>
                    </div>
                </div>
            </div>
